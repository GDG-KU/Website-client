  ...
  return (
    <div className={styles.faqContainer}>
      ...
      <div className={styles.faqTopBar}>
        <button className={styles.addFaqButton} onClick={() => setAddModalOpen(true)}>
          FAQ 추가하기
        </button>
      </div>
      ...
      <table className={styles.faqTable}>
        ...
        <tbody>
          {faqs.map((faq) => (
            <tr key={faq.id} onClick={() => openEditModal(faq)} style={{ cursor: "pointer" }}>
              <td>{faq.question}</td>
              <td>
        ...
        <div className={styles.modalOverlay} onClick={closeAddModal}>
          <div className={styles.modalContent} onClick={(e) => e.stopPropagation()}>
            ...
            <div className={styles.modalButtons}>
              <button className={styles.saveButton} onClick={createFAQ}>
                추가
              </button>
            </div>
          </div>
      ...
      {editModalOpen && modalFAQ && (
        <div className={styles.modalOverlay} onClick={closeEditModal}>
          <div className={styles.modalContent} onClick={(e) => e.stopPropagation()}>
            ...
            <div className={styles.modalButtons}>
              <button className={styles.updateButton} onClick={updateFAQ}>
                수정
              </button>
              <button
