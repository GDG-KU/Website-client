...
export default function ModalEditUser({ isOpen, onClose, user, onSave }: ModalEditUserProps) {
  ...
  return (
    <div className={styles["modal-edit-member-backdrop"]} onClick={onClose}>
      <div className={styles["modal-edit-member-content"]} onClick={(e) => e.stopPropagation()}>
        ...
        <div className={styles["formRow"]}>
          ...
          <select className={styles["formInput"]} value={editRole} onChange={(e) => setEditRole(e.target.value)}>
