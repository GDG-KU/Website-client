...
export default function ModalActivitySetting({ isOpen, onClose, activeTab, user, onSave }: ModalActivitySettingProps) {
  ...
  return (
    <div className={styles["modal-activity-setting-backdrop"]} onClick={onClose}>
      <div className={styles["modal-activity-setting-content"]} onClick={(e) => e.stopPropagation()}>
